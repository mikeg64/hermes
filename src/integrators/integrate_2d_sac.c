...
hyperdifviscl(fieldi,dim,Uinit, pG); 
		         ...
		         for(ii1=0;ii1<=1;ii1++)
		         {
				  ...
				  if(ii==dim)
				    hyperdifmomsource1(fieldi,dim,ii,ii0,pG->dt,Uinit, pG);
				  else
				    hyperdifmomsourcene1(fieldi,dim,ii,ii0,pG->dt,Uinit, pG);  //off diagonal
		        }
...
case 1:
 for (i3=kl; i3<=ku; i3++) {
    for (i2=jl; i2<=ju; i2++) {
    	for (i1=il; i1<=iu; i1++) {
			fieldf[AIN3(i1,i2,i3,dim)][AIN2(i1,i2,i3,dim)][AIN1(i1,i2,i3,dim)]=Uinit[i3][i2][i1].mom1;
					}
				}
			}
break;
...
case 2:
 for (i3=kl; i3<=ku; i3++) {
    for (i2=jl; i2<=ju; i2++) {
    	for (i1=il; i1<=iu; i1++) {
			fieldf[AIN3(i1,i2,i3,dim)][AIN2(i1,i2,i3,dim)][AIN1(i1,i2,i3,dim)]=Uinit[i3][i2][i1].mom2;
					}
				}
			}
break;
...
case 3:
 for (i3=kl; i3<=ku; i3++) {
    for (i2=jl; i2<=ju; i2++) {
    	for (i1=il; i1<=iu; i1++) {
			fieldf[AIN3(i1,i2,i3,dim)][AIN2(i1,i2,i3,dim)][AIN1(i1,i2,i3,dim)]=Uinit[i3][i2][i1].mom3;
					}
				}
			}
break;
...
case 1:
 for (i3=kl; i3<=ku; i3++) {
    for (i2=jl; i2<=ju; i2++) {
    	for (i1=il; i1<=iu; i1++) {
			fieldl[AIN3(i1,i2,i3,dim)][AIN2(i1,i2,i3,dim)][AIN1(i1,i2,i3,dim)]=Uinit[i3][i2][i1].mom1;
					}
				}
			}
break;
...
case 2:
 for (i3=kl; i3<=ku; i3++) {
    for (i2=jl; i2<=ju; i2++) {
    	for (i1=il; i1<=iu; i1++) {
			fieldl[AIN3(i1,i2,i3,dim)][AIN2(i1,i2,i3,dim)][AIN1(i1,i2,i3,dim)]=Uinit[i3][i2][i1].mom2;
					}
				}
			}
break;
...
case 3:
 for (i3=kl; i3<=ku; i3++) {
    for (i2=jl; i2<=ju; i2++) {
    	for (i1=il; i1<=iu; i1++) {
			fieldl[AIN3(i1,i2,i3,dim)][AIN2(i1,i2,i3,dim)][AIN1(i1,i2,i3,dim)]=Uinit[i3][i2][i1].mom3;
					}
				}
			}
break;
...
int fieldi=ii0;
	...
	Real ***tmprhor=NULL, ***tmprhol=NULL, ***tmpvr=NULL, ***tmpvl=NULL, ***tmpr=NULL, ***tmpl=NULL, ***tmp=NULL, ***tmp2=NULL, ***fieldd=NULL, ***fieldl=NULL;
        Real maxt1,maxt2;
	Real nur,nul;
...
{
case 1:
     pG->U[i3][i2][i1].mom1  += (dtodx1*(dim==1)+dtodx2*(dim==2)+dtodx3*(dim==3))*(tmpc[AIN3(i1,i2,i3,dim)][AIN2(i1,i2,i3,dim)][AIN1(i1,i2,i3,dim)]);
break;

case 2:
     pG->U[i3][i2][i1].mom2  += (dtodx1*(dim==1)+dtodx2*(dim==2)+dtodx3*(dim==3))*(tmpc[AIN3(i1,i2,i3,dim)][AIN2(i1,i2,i3,dim)][AIN1(i1,i2,i3,dim)]);
break;

case 3:
     pG->U[i3][i2][i1].mom3  += (dtodx1*(dim==1)+dtodx2*(dim==2)+dtodx3*(dim==3))*(tmpc[AIN3(i1,i2,i3,dim)][AIN2(i1,i2,i3,dim)][AIN1(i1,i2,i3,dim)]);
break;
