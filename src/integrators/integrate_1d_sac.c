...
static void hyperdifviscr(int fieldi,int dim,const ConsS ***Uinit, GridS *pG);
static void hyperdifviscl(int fieldi,int dim,const ConsS ***Uinit, GridS *pG);
...
static void hyperdifviscr(int fieldi,int dim,const ConsS ***Uinit,  GridS *pG)
{
   ...
   /*to here*/
	...
	pG->Hv[i3][i2][i1].hdnur[dim][fieldi]=((dim==0)*(pG->dx1)+(dim==1)*(pG->dx2))*(pG->cmax)*(pG->chyp[fieldi])*wtemp2[i3][i2][i1]/wtemp3[i3][i2][i1];
...
static void hyperdifviscl(int fieldi,int dim,const ConsS ***Uinit,  GridS *pG)
{
	...
	for (i1=il; i1<=iu; i1++)
	{
		...
		pG->Hv[i1][i2][i3].hdnul[dim][fieldi]=0.0;
	...
	i3=ks;
        i2=js;
	for (i1=il; i1<=iu; i1++)
		   d1[i3][i2][i1+1]=fabs((tmpnu[i3][i2][i1+1] - tmpnu[i3][i2][i1+(dim==0)+1]  ));
   ...
   /*to here*/
	...
	pG->Hv[i3][i2][i1].hdnul[dim][fieldi]=((dim==0)*(pG->dx1)+(dim==1)*(pG->dx2))*(pG->cmax)*(pG->chyp[fieldi])*wtemp2[i3][i2][i1]/wtemp3[i3][i2][i1];
