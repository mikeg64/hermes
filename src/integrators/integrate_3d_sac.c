...
/*static void hyperdifrhosource(int field,int dim,Real dt,ConsS ***Uinit, GridS *pG);
static void hyperdifesource(int dim,Real dt,ConsS ***Uinit, GridS *pG); 
static void hyperdifmomsource(int field,int dim,int ii,int ii0,Real dt,ConsS ***Uinit, GridS *pG);
static void hyperdifmomsourcene(int field,int dim,int ii,int ii0, Real dt,ConsS ***Uinit, GridS *pG);*/

#ifdef MHD
//static void hyperdifbsource(int ii,int ii0, Real dt, ConsS ***Uinit, GridS *pG);
//static void hyperdifbsourcene(int ii,int ii0, Real dt, ConsS ***Uinit, GridS *pG);
#endif /* MHD */
