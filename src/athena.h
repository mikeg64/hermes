...
#include "defs.h"
	...
	#include "smaug/include/gpudefs.h"
#endif
...
typedef struct Cons1D_s{
  ...
  Real Bzb;
#endif
			/*!< cell centered magnetic fields in 2-dir*/
#ifdef SMAUG_INTEGRATOR
  Real db;
  Real Eb;
  Real Byb;			/*!< cell centered magnetic fields in 1-dir*/
