...
#define CONFIGURE_DATE "Mon Apr 25 23:25:52 BST 2022"
...
/* flux type
 * ROE_FLUX, HLLE_FLUX, HLLC_FLUX, HLLD_FLUX, FORCE_FLUX, EXACT_FLUX, SAC_FLUX, SMAUG_FLUX,
 * TWO_SHOCK_FLUX */
#define HLLD_FLUX
...
/* SMAUG mode: SMAUG_ENABLED or NO_SMAUG */
#define NO_SMAUG
...
/* macros used to set indices for 3D arrays used for gradient computations
   in the SAC hyperdiffusion source terms  */
   
#ifndef AIN3
 #define AIN3(i1,i2,i3,dim) ((i3)*((dim)==0 || (dim)==1)+(i1)*((dim)==2))
#endif

#ifndef AIN2
 #define AIN2(i1,i2,i3,dim) ((i2)*((dim)==0  || (dim)==2)+(i1)*((dim)==1))
#endif

#ifndef AIN1
 #define AIN1(i1,i2,i3,dim) ((i1)*((dim)==0)+(i2)*((dim)==1)+(i3)*((dim)==2))
#endif
